...
public abstract class CalendarView extends View {
    ...
    protected Map<String, Boolean> pointMap;
    ...
    public void setDateTimeAndPoint(DateTime dateTime, List<String> pointList, List<Integer> tags) {
        this.mSelectDateTime = dateTime;
    ...
    public void setPointList(List<String> pointList, List<Integer> tags) {
        this.pointList = pointList;
        this.tags = tags;
        invalidate();
    }
