...
import com.beihui.market.injection.component.DaggerXNetLoanAccountInputComponent;
 ...
 * 网贷记账
 */
public class XNetLoanAccountInputActivity extends BaseComponentActivity implements XNetLoanAccountInputContract.View {
    ...
    @Inject
    XNetLoanAccountInputPresenter presenter;
    ...
    protected void configureComponent(AppComponent appComponent) {
        DaggerXNetLoanAccountInputComponent.builder()
                .appComponent(appComponent)
                .xNetLoanAccountInputModule(new XNetLoanAccountInputModule(this))
                .build()
                .inject(this);
    }

    @Override
    public void setPresenter(XNetLoanAccountInputContract.Presenter presenter) {
        //
    }
