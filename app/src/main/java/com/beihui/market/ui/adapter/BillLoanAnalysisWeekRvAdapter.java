...
public class BillLoanAnalysisWeekRvAdapter extends RecyclerView.Adapter<BillLoanAnalysisWeekRvAdapter.ViewHolder> {
...
//    public static final int VIEW_FOOTER = R.layout.x_item_bill_loan_analysis_footer;
    ...
    public BillLoanAnalysisWeekRvAdapter(Activity mActivity) {
