 ...
 * 网贷记账
 */
public class XNetLoanAccountInputPresenter extends BaseRxPresenter implements XNetLoanAccountInputContract.Presenter {
    ...
    @Inject
    XNetLoanAccountInputPresenter(Context context, Api api, XNetLoanAccountInputContract.View view) {
                ...
                .subscribe(new Consumer<ResultEntity<LinkedHashMap<String, List<DebtChannel>>>>() {
                        ...
                        new Consumer<Throwable>() {
                            ...
                            public void accept(Throwable throwable) throws Exception {
                                logError(XNetLoanAccountInputPresenter.this, throwable);
