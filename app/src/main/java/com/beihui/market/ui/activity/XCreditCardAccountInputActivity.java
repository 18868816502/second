...
import com.beihui.market.injection.component.DaggerXCreditCardAccountInputComponent;
...
import com.beihui.market.ui.presenter.XCreditCardAccountInputPresenter;
 ...
 * 添加信用卡账单
 */
public class XCreditCardAccountInputActivity extends BaseComponentActivity implements XCreditCardAccountInputContract.View {

    @BindView(R.id.tl_credit_card_input_account_bar)
    Toolbar toolbar;

    @Inject
    XCreditCardAccountInputPresenter presenter;
    ...
    protected void configureComponent(AppComponent appComponent) {
        DaggerXCreditCardAccountInputComponent.builder()
                .appComponent(appComponent)
                .xCreditCardAccountInputModule(new XCreditCardAccountInputModule(this))
                .build()
                .inject(this);
    }
    ...
    @Override
    public void setPresenter(XCreditCardAccountInputContract.Presenter presenter) {
        //
    }
    ...
    public void navigateMoreSourceChannel() {
        startActivity(new Intent(this, XNetLoanAccountInputActivity.class));
    }
