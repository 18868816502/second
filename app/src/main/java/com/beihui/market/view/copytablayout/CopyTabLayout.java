package com.beihui.market.view.copytablayout;
...
public class CopyTabLayout extends HorizontalScrollView {
    ...
    private static final Pools.Pool<CopyTabLayout.Tab> sTabPool = new Pools.SynchronizedPool<>(16);
    ...
    /**
     * Gravity used to fill the {@link CopyTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link CopyTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public void onTabSelected(CopyTabLayout.Tab tab);
         ...
         */
        public void onTabUnselected(CopyTabLayout.Tab tab);
         ...
         */
        public void onTabReselected(CopyTabLayout.Tab tab);
    }

    private final ArrayList<Tab> mTabs = new ArrayList<>();
    private CopyTabLayout.Tab mSelectedTab;

    private final CopyTabLayout.SlidingTabStrip mTabStrip;
    ...
    private CopyTabLayout.OnTabSelectedListener mSelectedListener;
    private final ArrayList<OnTabSelectedListener> mSelectedListeners = new ArrayList<>();
    private CopyTabLayout.OnTabSelectedListener mCurrentVpSelectedListener;
    ...
    private CopyTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;
    private CopyTabLayout.AdapterChangeListener mAdapterChangeListener;
    ...
    private final Pools.Pool<CopyTabLayout.TabView> mTabViewPool = new Pools.SimplePool<>(12);
    ...
    public CopyTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        CopyThemeUtils.checkAppCompatTheme(context);

        // Disable the Scroll Bar
        setHorizontalScrollBarEnabled(false);

        // Add the TabStrip
        mTabStrip = new CopyTabLayout.SlidingTabStrip(context);
        ...
        indicatorMarginBottom = (int) (getResources().getDisplayMetrics().density * 10);
     ...
     */
    public void addTab(@NonNull CopyTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull CopyTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull CopyTabLayout.Tab tab, boolean setSelected) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull CopyTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different CopyTabLayout.");
        }
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(CopyTabLayout.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(CopyTabLayout.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable CopyTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link CopyTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(CopyTabLayout.OnTabSelectedListener)}.</p>
     *
     * @param listener listener to add
     */
    public void addOnTabSelectedListener(@NonNull CopyTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link CopyTabLayout.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(CopyTabLayout.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull CopyTabLayout.OnTabSelectedListener listener) {
        mSelectedListeners.remove(listener);
    }

    /**
     * Remove all previously added {@link CopyTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Create and return a new {@link CopyTabLayout.Tab}. You need to manually add this using
     * {@link #addTab(CopyTabLayout.Tab)} or a related method.
     *
     * @return A new Tab
     * @see #addTab(CopyTabLayout.Tab)
     */
    @NonNull
    public CopyTabLayout.Tab newTab() {
        CopyTabLayout.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new CopyTabLayout.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public CopyTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(CopyTabLayout.Tab tab) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab does not belong to this CopyTabLayout.");
        }
    ...
    public void removeTabAt(int position) {
        ...
        final CopyTabLayout.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<Tab> i = mTabs.iterator(); i.hasNext(); ) {
            final CopyTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
     ...
     */
    public void setTabMode(@CopyTabLayout.Mode int mode) {
        if (mode != mMode) {
            mMode = mode;
            applyModeAndGravity();
        }
    ...
    /**
     * Returns the current mode used by this {@link CopyTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @CopyTabLayout.Mode
     ...
     */
    public void setTabGravity(@CopyTabLayout.TabGravity int gravity) {
    ...
    /**
     * The one-stop shop for setting up this {@link CopyTabLayout} with a {@link ViewPager}.
     * <p>
     ...
     * The one-stop shop for setting up this {@link CopyTabLayout} with a {@link ViewPager}.
     * <p>
     * <p>This method will link the given ViewPager and this CopyTabLayout together so that
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new CopyTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            mCurrentVpSelectedListener = new CopyTabLayout.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (mAdapterChangeListener == null) {
                mAdapterChangeListener = new CopyTabLayout.AdapterChangeListener();
            }
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link a CopyTabLayout with a ViewPager
     * together. When that method is used, the CopyTabLayout will be automatically updated
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new CopyTabLayout.PagerAdapterObserver();
            }
    ...
    private CopyTabLayout.TabView createTabView(@NonNull final CopyTabLayout.Tab tab) {
        CopyTabLayout.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new CopyTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(CopyTabLayout.Tab tab, int position) {
    ...
    private void addTabView(CopyTabLayout.Tab tab) {
        final CopyTabLayout.TabView tabView = tab.mView;
    ...
    private void removeTabViewAt(int position) {
        final CopyTabLayout.TabView view = (CopyTabLayout.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == CopyTabLayout.Tab.INVALID_POSITION) {
            return;
        }
    ...
    private void ensureScrollAnimator() {
        if (mScrollAnimator == null) {
            ...
            mScrollAnimator.setInterpolator(CopyAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    void selectTab(CopyTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(final CopyTabLayout.Tab tab, boolean updateIndicator) {
        final CopyTabLayout.Tab currentTab = mSelectedTab;
        ...
        if (currentTab == tab) {
            ...
            final int newPosition = tab != null ? tab.getPosition() : CopyTabLayout.Tab.INVALID_POSITION;
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == CopyTabLayout.Tab.INVALID_POSITION)
                        && newPosition != CopyTabLayout.Tab.INVALID_POSITION) {
    ...
    private void dispatchTabSelected(@NonNull final CopyTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabSelected(tab);
        }
    }

    private void dispatchTabUnselected(@NonNull final CopyTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabUnselected(tab);
        }
    }

    private void dispatchTabReselected(@NonNull final CopyTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
    ...
    public static final class Tab {
        ...
        CopyTabLayout mParent;
        CopyTabLayout.TabView mView;
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a CopyTabLayout");
            }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a CopyTabLayout");
            }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a CopyTabLayout");
            }
         ...
         */
        @NonNull
        public CopyTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    class TabView extends LinearLayout {
        private CopyTabLayout.Tab mTab;
        ...
        void setTab(@Nullable final CopyTabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
        ...
        final void update() {
            final CopyTabLayout.Tab tab = mTab;
        ...
        public CopyTabLayout.Tab getTab() {
            return mTab;
        }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setInterpolator(CopyAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        setIndicatorPosition(
                                CopyAnimationUtils.lerp(startLeft, targetLeft, fraction),
                                CopyAnimationUtils.lerp(startRight, targetRight, fraction));
                    }
                });
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                int center = (mIndicatorRight + mIndicatorLeft) / 2;
                rectF.set(center - indicatorLength / 2, getHeight() - indicatorMarginBottom - mSelectedIndicatorHeight,
                        center + indicatorLength / 2, getHeight() - indicatorMarginBottom);
                canvas.drawRoundRect(rectF, mSelectedIndicatorHeight / 2, mSelectedIndicatorHeight / 2, mSelectedIndicatorPaint);
            }
        }
    }
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            CopyTabLayout.Tab tab = mTabs.get(i);
     ...
     * necessary calls back to the provided {@link CopyTabLayout} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided CopyTabLayout weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CopyTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(CopyTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final CopyTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link CopyTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements CopyTabLayout.OnTabSelectedListener {
