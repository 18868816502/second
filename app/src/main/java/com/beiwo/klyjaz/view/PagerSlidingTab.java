...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFff5240;    //指示线的颜色#006BCE
    private int underlineColor = 0xfff5f5f5;    //tab下划线的颜色
    private int dividerColor = 0x00000000;        //tab之间的分割线的颜色 需求不需要 我将它设置成透明
    ...
    private int underlineHeight = 1;        //下划线的高度
    private int dividerPadding = 12;
    private int tabPadding = 15;            //tab间的距离
    private int dividerWidth = 1;

    private int tabTextSize = 14;
    private int tabTextColor = 0xFF909298;        //Tab 字体未选择的颜色
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle_NORMAL = Typeface.NORMAL;
    private int tabTypefaceStyle_BOLD = Typeface.BOLD;

    private int lastScrollX = 0;

    //tab按下的选择色
    private int tabBackgroundResId = 0xff424251;
...
//				}
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextColor(i == 0 ? getResources().getColor(R.color.black_1) : tabTextColor);
                tab.setTypeface(tabTypeface, tabTypefaceStyle_BOLD);
                tab.setTextSize(i == pager.getCurrentItem() ? 18 : 14);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //修改指示线的宽度
//		float lineOffset = (lineRight - lineLeft - 58) / 2;
        float lineOffsetLeft = currentTab.getPaddingLeft();
        float lineOffsetRight = currentTab.getPaddingRight();
        ...
        canvas.drawRect(lineLeft + lineOffsetLeft, height - indicatorHeight, lineRight - lineOffsetRight, height, rectPaint);
        //绘制在上边的线
...
//		canvas.drawRoundRect(rect, 8, 8, rectPaint);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ? getResources().getColor(R.color.black_1) : tabTextColor);
                    textView.setTypeface(tabTypeface, i == pager.getCurrentItem() ? tabTypefaceStyle_BOLD : tabTypefaceStyle_NORMAL);
                    textView.setTextSize(i == pager.getCurrentItem() ? 18 : 14);
                }
            }
        }
    }
    ...
    public void setTypeface(Typeface typeface, int style) {
        ...
        this.tabTypefaceStyle_BOLD = style;
        updateTabStyles();
    }
