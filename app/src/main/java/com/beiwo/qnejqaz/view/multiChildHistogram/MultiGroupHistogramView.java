package com.beiwo.qnejqaz.view.multiChildHistogram;
...
public class MultiGroupHistogramView extends View {
            ...
            for (MultiGroupHistogramGroupData groupData : dataList) {
                ...
                if (childDataList != null && childDataList.size() > 0) {
                    ...
                    for (int i = 0; i < childDataList.size(); i++) {
                        ...
                        String childHistogramHeightValue = DisplayUtil.NumericScaleByFloor(String.valueOf(childData.getValue()), histogramValueDecimalCount) + childData.getSuffix();
    ...
    public interface OnItemClickListener{
        void onItemClick(int posisiton);
    }
