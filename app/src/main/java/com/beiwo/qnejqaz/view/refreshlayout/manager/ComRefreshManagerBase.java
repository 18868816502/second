package com.beiwo.qnejqaz.view.refreshlayout.manager;
...
import com.beiwo.qnejqaz.view.refreshlayout.RefreshLayout;

public abstract class ComRefreshManagerBase extends RefreshLayout.RefreshManager {

    private static final float SCROLL_RATE = .36f;
    ...
    protected boolean canMotionTriggerRefresh() {
        int distance = getRefreshTriggerDistance();
        return distance > 0 && Math.abs(mCurrentViewOffset) > distance;
    }
