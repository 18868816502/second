 ...
 */
public class Pop2Dialog extends BaseDialog {
        ...
        getDialog().setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                if(mDismissListener != null) {
                    mDismissListener.onDismiss(Pop2Dialog.this);
                }
            }
        });
...
//            mDialog.mDialogType = mDialogType;
    ...
    public interface OnInitPopListener {
        void initPop(View view, Pop2Dialog mPopDialog);
    }

    public interface OnDismissListener{
        void onDismiss(Pop2Dialog mPopDialog);
    }
