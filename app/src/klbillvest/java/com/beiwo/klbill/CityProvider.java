...
public class CityProvider extends ContentProvider {
    ...
    public static void createTmpCityTable(Context context) {
        SQLiteDatabase db = context.openOrCreateDatabase(
                Dispose3.getDBFilePath(context), Context.MODE_PRIVATE, null);
        Dispose1.i("liweiping", "create table tmpcity ....");
    ...
    public boolean onCreate() {
        mSqLiteDatabase = getContext().openOrCreateDatabase(
                Dispose3.getDBFilePath(getContext()), Context.MODE_PRIVATE,
                null);
        Dispose1.i("liweiping", "create db....");
        return true;
    }
